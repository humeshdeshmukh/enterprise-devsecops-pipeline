...
PRODUCTS = [
    ...
    {"id": 2, "name": "Kubernetes Mastery Course", "price": 199.99, "category": "Education"},
    {"id": 3, "name": "DevSecOps Automation Tool", "price": 29.99, "category": "Software"}
]
...
def health_check():
    ...
    health_status = {
        ...
        "checks": {
            "database": {
                "status": "UP",
                "latency_ms": 0.5  # Mocked latency check
            },
            "system": {
                "status": "UP",
                "memory_healthy": True
